...
$experience = [
    [
        ...
        'percent' => 'Business Intelligence аналитик',
        'name' => 'Аналитик',
        'percent2' => 'Jan 2015 -',
        'percent3' =>  Current,
    ],
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        Опыт работы
            ...
            <div class="w3-container">
              <h5 class="w3-opacity"><b><?php echo $experience[$i]['percent']; ?></b></h5>
              <p><?php echo $experience[$i]['name']; ?></p>
              <h6 class="w3-text-teal">
                <i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['percent2']; ?></b>
                <span class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['percent3']; ?></b></span>
              </h6>
